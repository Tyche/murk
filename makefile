...
DEFS = -DOS_UNIX=0 -DOS_WIN=1 -DHAVE_USLEEP=1 -DHAVE_FDATASYNC=1 -DNDEBUG -DSQLITE_OMIT_UTF16 -DSQLITE_OMIT_AUTHORIZATION
# For other unixes
#DEFS = -DOS_UNIX=1 -DOS_WIN=0 -DHAVE_USLEEP=1 -DHAVE_FDATASYNC=1 -DNDEBUG -DSQLITE_OMIT_UTF16 -DSQLITE_OMIT_AUTHORIZATION
# For FreeBSD
#DEFS = -DOS_UNIX=1 -DOS_WIN=0 -DHAVE_USLEEP=1 -DNDEBUG -DSQLITE_OMIT_UTF16 -DSQLITE_OMIT_AUTHORIZATION
